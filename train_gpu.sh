...
for argset in   "-m multifold -u manyfold --eff-acc" "-m multifold -u manyfold --dosysweight --dataweight gen_CP5_to_EPOS_multifold" "-m multifold -u manyfold --dogenreweight --dataweight gen_CP5_to_EPOS_multifold"; do
